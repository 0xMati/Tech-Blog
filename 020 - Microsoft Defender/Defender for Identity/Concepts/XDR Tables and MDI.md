---
title: "Microsoft Defender for Identity and the XDR Advanced Hunting tables"
date: 2025-12-04
---
...
| ----------------------------------------------------- | -------------------------- | ------------ | --------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **MDI / Microsoft Defender XDR Console**              | **30/180 days**               | ❌ No         | Defender XDR portal (Incidents, Alerts)              | MDI signals are retained by **Microsoft Defender XDR for 180 days**. But a 30‑day limit applies **only to Advanced Hunting**, not to XDR portal data.   | An attacker performed lateral movement 45 days ago → the activity **is still visible** in Defender XDR incidents and alerts.                  |
| **Microsoft Sentinel (Analytics / Hot tier)**         | **90 days (default)**      | ✅ Yes        | Sentinel (Log Analytics, KQL)                        | When MDI is connected to Sentinel, its signals are ingested into Log Analytics. By default, Sentinel keeps analytics data for 90 days.               | An NTLM relay detected by MDI 60 days ago → **not queryable in Advanced Hunting**, but **still queryable in Sentinel**.                        |
...
| **Microsoft Sentinel Archive / Data Lake**            | **Years (up to multi‑year)** | ✅ Yes        | Archive tier / Data Lake                             | Data can be archived for multi‑year retention at lower cost. Queries require restore or archive search and are not real-time.                      | A compliance audit requires identity activity from 2 years ago → data is **retrieved from archive storage**.                                  |
