...
# Generates a rich HTML report for Phase 3 — Create Deny Logon GPOs for each Tiers.
...
<p class="subtitle">Create Deny Logon GPOs for each Tiers | Domain: $(HtmlEncode $DomainDN) | Generated: $timestamp</p>
...
<p class="note" style="text-align:center;margin-top:2rem;">Generated by MATI — Phase 3 — Create Deny Logon GPOs for each Tiers</p>
</div></body></html>
"@
