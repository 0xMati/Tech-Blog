...
- **[`Tools/Invoke-KerberosEncryptionAudit.ps1`](./Tools/Invoke-KerberosEncryptionAudit.ps1)** — the read-only audit script that automates the inventory phase: KDC default per DC, account `msDS-SupportedEncryptionTypes` posture, and 4768/4769 traffic correlated into an HTML / JSON / CSV report. Documented in Article 2 §6.
