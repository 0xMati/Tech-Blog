...
| 6 | KDC | Build service ticket internals (`EncTicketPart`) | `{client identity, authz/PAC, K_c,s}` sealed with `K_svc` | Opaque service ticket blob | Ticket blob etype follows service account keys/policy (the main RC4 hotspot) |
