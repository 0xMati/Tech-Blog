...
> 🔑 **"Long-term key" = `KDF(password)`.** Active Directory never stores passwords in cleartext — it stores keys derived from the password through a Key Derivation Function. Each enctype has its own KDF:
>
