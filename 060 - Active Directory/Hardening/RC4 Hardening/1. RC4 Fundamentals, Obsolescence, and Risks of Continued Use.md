...
This is the technical core of *"obsolete"*. It isn't about RC4 being a "broken cipher" in the academic sense — the famous RC4 biases (RC4 NOMORE, FMS, etc.) need millions of ciphertexts encrypted with the same key and **do not apply to a single Kerberos ticket**. The real throughput gap is in how the long-term key is derived from the password:
