...
| **T24** | Trust | TDO Mixed (`msDS-SupportedEncryptionTypes = 0x1C`) | Same as T23 with `=28`. | `Classification = 'Mixed'`. | Same as T23. |
| **T25** | Trust | TDO DES (`msDS-SupportedEncryptionTypes = 0x1`) | Same as T23 with `=1`. | `Classification = 'Legacy-DES'`. Backlog row with `FixCost = High`. | Same as T23. |
