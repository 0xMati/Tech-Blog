...
![](assets/Krgbtgt%20Account%20and%20Recommandations/2025-07-03-12-55-06.png)

- You can review practical information about it:

![](assets/Krgbtgt%20Account%20and%20Recommandations/2025-07-03-12-55-56.png)

- Run !

![](assets/Krgbtgt%20Account%20and%20Recommandations/2025-07-03-12-58-58.png)

Note:
• This script is not Microsoft-supported—run it at your own risk and review the code beforehand (there is official Microsoft Script)
• Always test in a non-prod OU first and monitor replication before round two.
• For RODC-specific resets, adjust -Scope (e.g. -Scope AllRODCs or specify individual servers).


### 'New-KrbtgtKeys.ps1' Script here if needed
