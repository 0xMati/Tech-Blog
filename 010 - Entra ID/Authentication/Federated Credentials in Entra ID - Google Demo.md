...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-33-39.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-35-26.png>)

- Click "Get Started"
- App name → MyGoogleEntraFederatedApp
- User support email → your Google account email

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-37-58.png>)

- Audience → External

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-38-26.png>)

- Developer contact information → same email

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-39-13.png>)

- Finish and create

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-39-36.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-43-34.png>)

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-43-45.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-45-16.png>)

- Click Create credentials → OAuth client ID.

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-46-24.png>)
    ...
    ![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-47-06.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-48-08.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-49-42.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-50-55.png>)

- Click Create and Continue.
- Leave roles/permissions/Principals access empty (we don’t need any resource access).

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-51-44.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-22-54-03.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-14-49.png>)

- Search for IAM Service Account Credentials API.

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-15-16.png>)

- Make sure it is enabled, then click "Manage"

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-15-36.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-24-27.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-26-14.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-29-53.png>)

- Authorize with a minimal scope: https://www.googleapis.com/auth/cloud-platform

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-30-58.png>)

    - Click Authorize APIs → sign in → Allow

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-31-38.png>)

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-32-03.png>)

    - click Exchange authorization code for tokens

You should now see an Access token.

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-33-58.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-38-12.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-39-08.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-40-39.png>)
...
- In the Azure portal, open Microsoft Entra ID → App registrations → New registration.
 ...
 ![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-42-18.png>)   

 - Add a Federated Credential

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-43-27.png>)

![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-43-48.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-45-06.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-48-20.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-49-09.png>)
...
![](<./assets/Federated Credentials in Entra ID - Google Demo/2025-10-20-23-50-32.png>)
