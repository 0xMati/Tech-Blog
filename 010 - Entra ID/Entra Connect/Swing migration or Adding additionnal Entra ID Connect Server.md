...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-15-55-55.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-15-57-01.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-15-57-18.png>)

    - Choose “View or export current configuration”

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-15-57-38.png>)

    - Clic on “Export settings”

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-15-58-00.png>)

    - Save the file and copy it to the server that you will use as passive/Staging

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-15-58-37.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-15-59-41.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-15-59-51.png>)

    - Do not Use “Express Setting”, use the Customize option

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-00-19.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-01-19.png>)

    - Custom installation location let you install the product in another location:

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-01-48.png>)

    - Use an existing SQL Server is only used if you are using a SQL Server instead of SQ Express:

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-02-07.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-03-07.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-03-22.png>)

    - Use Custom groups for Entra ID connect administration:

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-03-49.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-04-04.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-04-32.png>)

    - Launch the install and wait until finish

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-04-56.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-06-48.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-07-16.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-07-37.png>)

    - In the passive server, fill in credentials to use:

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-08-12.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-08-22.png>)

    - Review all configuration that will automatically be done and be sure that the check box to enable staging mode is enable

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-08-45.png>)

Wait for the process to complete and your passive/staging server is ready.

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-09-11.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-10-05.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-10-18.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-13-03.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-13-12.png>)

On the staging server:

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-13-31.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-14-22.png>)

•	Extract the zip file, this will extract the Documenter application binaries along with the sample data files for "Contoso".

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-14-38.png>)

•	Create a folder structure for your organization:

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-15-02.png>)

•	Edit the cmd file to match your structure:

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-15-20.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-15-27.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-15-53.png>)

-	Run the cmd to generate the report:

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-16-08.png>)

-	You can now analyze the report:

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-16-22.png>)

-	You can filter the report to show only difference between platforms:

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-16-38.png>)

-	You’ll be able to see all differences between your 2 servers:

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-16-53.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-17-02.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-17-12.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-18-41.png>)

-	On the Passive/Staging server, find the tool CSEXPORT in “C:\Program Files\Microsoft Azure AD Sync\Bin”

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-18-56.png>)

-	Export pending operation for your MAs:
csexport.exe "Connector_name" /f:x

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-19-10.png>)

Example 1:
csexport "mamotron.onmicrosoft.com - AAD" /f:x
csexport "mathiasmotron.com" /f:x

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-19-28.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-19-55.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-20-25.png>)

.\CSExportAnalyzer.exe "input_xml" > "output_csv”

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-20-39.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-20-51.png>)

-	You’ll be able to quickly see what kind of changes will be triggered and analyze why:

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-21-06.png>)

--> OMODT column will tell what kind of operation will be performed, it could be ADD, DELETE or UPDATE

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-21-26.png>)

--> AMODT column will tell you in case of UPDATE what will be changed :

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-21-43.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-23-06.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-23-14.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-23-32.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-24-25.png>)

-	Choose Staging mode option:

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-24-39.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-24-55.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-25-07.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-25-23.png>)
...
![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-25-45.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-25-53.png>)

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-26-00.png>)

-	Regularly export your custom Sync Rules:

![](<./assets/Swing migration or Adding additionnal Entra ID Connect Server/2025-04-24-16-26-14.png>)
