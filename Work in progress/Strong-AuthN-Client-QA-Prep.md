...
| 9 | Peut-on configurer WHfB pour forcer TPM + PIN + biométrie via policy ? | **Oui** : TPM obligatoire (Intune/GPO), PIN avec règles de complexité (WHfB policy), biométrie activée comme méthode complémentaire. Les 3 sont configurables et exigibles en production. | Section 3.2 — Implementation notes |
