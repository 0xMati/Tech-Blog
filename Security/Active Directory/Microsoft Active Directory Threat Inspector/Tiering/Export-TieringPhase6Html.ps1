...
<div class="step-card"><div class="step-number">5</div><div class="step-text"><strong>Phase 7 — Tier 0 Object Protection</strong> — Audit ACLs, secure GPOs, rotate krbtgt, and harden service account administration.</div></div>
</div></div>
