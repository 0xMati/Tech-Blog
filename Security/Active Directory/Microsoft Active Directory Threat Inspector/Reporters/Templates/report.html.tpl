...
<body>
    ...
    <div class="footer">
        ...
        <p>Generated by <strong>MATI</strong> — an open-source Active Directory security assessment tool. <a href="https://github.com/0xMati/Tech-Blog/tree/main/Security/Active%20Directory/Microsoft%20Active%20Directory%20Threat%20Inspector" target="_blank">GitHub</a></p>
    </div>
