...
| Scope                                                 | Retention Period           | Configurable | Where Data Is Accessible                            | Explanation                                                                                                                                          | Practical Example                                                                                                                             |
| ----------------------------------------------------- | -------------------------- | ------------ | --------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **MDI / Microsoft Defender XDR Console**              | **180 days**               | ❌ No         | Defender XDR portal (Incidents, Alerts)              | MDI signals are retained by **Microsoft Defender XDR for 180 days**. The 30‑day limit applies **only to Advanced Hunting**, not to XDR portal data.   | An attacker performed lateral movement 45 days ago → the activity **is still visible** in Defender XDR incidents and alerts.                  |
